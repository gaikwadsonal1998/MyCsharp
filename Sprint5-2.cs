/*
C#-Toys Rental-Sprint 5.2
bookmark_border
subject Codingcasino 100 points
DESCRIPTION
Part 1 :
Create and implement all the classes , interfaces mentioned in "C#-Toys Rental Sprint 4.1

Note : You need to implement below classes as mentioned in "C#-Toys Rental Sprint 4.1."
...
Part 2 :
  Create a class CostomerBO and add the below methods.
...
Note : Text presentation of the above table is given below for your reference.



List<Customer> GetCustomers() : Gets the list of all customers available



List<Toy> GetToys(): Gets the list of all toys available



Void DeleteCustomer(int id): Deletes a customer based on id



Void UpdateToy(int id): Updates price,quantity,rental amount of a toy based on the toy id



List<Customer> GetCustomersByCountry(string country): Gets the list of customer objects for a given country



Dictionary<string,int> GetToysByPrice (int min,int max): Gets name,price of all toys whose price ranges between x and y



Void CountCustomersByCountry() : Prints the Country name, number of customers in each country
*/
