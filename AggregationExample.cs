/*
C# Lab Exercise : Aggregation Example
bookmark_border
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
           ...
           s1.setStreetName("Bangalore");
            ...
            Console.WriteLine("Emp streetName is = xxx");
            Console.WriteLine("Emp streetName is = "+s1.getStreetName());
