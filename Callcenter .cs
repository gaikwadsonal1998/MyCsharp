...
Call center ticket
Below are the details for open-tickets, in-progress ticket and closed tickets for all the call centre employees which needs to be efficiently stored in a memory using arrays.  Use DisplayArray function to display the same.
