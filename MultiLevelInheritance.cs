/*
C#Lab Exercise : Multi Level Inheritance
bookmark_border
...
Note : Create object of the SalesManagement class in the Main() and initialize all necessary variables with the help of 
member functions defined inside the class.
The program do not take any input data 
.Argument for all member functions is hard coded in the program to get the required output
